...
const PLANS = [
  {
    ...
    limitations: ["No Milli Cents", "No checking account", "No Visa card", "No AI assistant"],
  },
  {
    id: "pro",
    name: "Pro",
    ...
    features: [
      ...
      "Investing auto-pilot",
      "Retirement auto-contributions",
      "Savings goals",
      "Advanced tax reports",
      "Priority support",
    ],
    limitations: ["No checking account", "No Visa debit card"],
  },
  {
    id: "elite",
    name: "Elite",
